...
let productEl = document.querySelector(".shop-section");
let CartItemsEl = document.querySelector(".cart-wrapper");
let subtotalEl= document.querySelector(".subtotal")
let totalCartItemsEl = document.querySelector(".non-empty");
...
function renderProducts() {
  products.forEach((product, index) => {
    productEl.innerHTML += `
        <div data-id=${product.id} class="card-wrapper">
        <div class="card-item">
            ...
            <div class="details">
                ...
                <p>Description: ${product.description}<span id="dots">...</span> <span id="more">
                ...
                <span class="category">Category:  ${
                  ...
                  product.category.slice(1)
                    ...
                    <span class="count"> Instock:${product.rating.count}</span>
                    
                    <span class="add-to-cart-btn" onclick="addToCart(${
                      product.id
                    })">Add to Cart</span>
                </p>
            </div>
...
function renderSubtotal(){
  let totalPrice=0,
   ...
   `
   totalCartItemsEl.innerHTML=` ${totalItems}`
}
...
function renderCart() {
  ...
  Cart.forEach((item) => {
    CartItemsEl.innerHTML += `
            <div class="cart-item" >
                <img src="${item.image}" alt="" onclick="remove(${item.id})">
                <div class="details">
                    <h3>
                      ${item.title}
                    </h3>
...
// INWINDOW-SO THAT WHEN YOU MIVE THE MOVE DOWNWARD THE HIDE WILL STILL SHOW
